              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-medium text-black dark:text-white">안기모</span>
            ...
            <div className="flex gap-4 items-start pt-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-end mt-2">
                  <button className="px-4 py-2 text-sm font-medium text-white bg-indigo-500 rounded-lg hover:bg-indigo-600">
                    댓글
                  </button>
                </div>
              </div>
